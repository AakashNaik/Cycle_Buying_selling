...
public class forgot_password extends javax.swing.JFrame {
     ...
     */
    public String forgot_password_check(String roll_number,String name)
    {
        try{
             ...
             Statement st=con.createStatement();
                    String pass = null;
             ResultSet rs=st.executeQuery("select * from User_name where Roll_Number='"+roll_number+"' and Name='"+name+"'");
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(218, 159, 99));
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(22, 22, 22)
                        .addComponent(user_name, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(118, 118, 118)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                 // TODO add your handling code here:
                String roll_number= roll.getText();
                String name=user_name.getText(); 
                this.forgot_password_check(roll_number, name);
